              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 py-3.5 px-4 border border-gray-300 rounded-xl text-gray-700 font-medium hover:bg-gray-50 transition-colors"
                  >
                    Use Different Email
                  </button>
              ...
              <div className="space-y-5">
                ...
                <p className="text-sm text-gray-500 text-center">
                  ...
                  <button 
                    ...
                    className="text-nomad-primary hover:text-nomad-accent font-medium transition-colors"
                  >
                    Resend
                  </button>
                </p>
